...
import './assets/default-profile-pic.jpg' 
import './App.css'
...
function ForumPublic({admin}) {
    ...
    return (
        ...
        <div class="header_part">
			...
			<div class="header_mForumPublicddle"><h1>Organiz'asso</h1>
    ...
    return (
		...
		<div class="header_part">
			...
			<div class="liens">
				<a href="OuvrirUneSession.html">Connexion</a>
				<a href="Enregistrer.html">S'enregistrer</a><br/>
				<img id="profile_pic" src="./assetsdefault-profile-pic.jpg" alt="Photo de profil"/> 
			</div>
		</div>
        <ListMessages admin="false"/>
        </>
    )
