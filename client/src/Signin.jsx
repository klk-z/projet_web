  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit}>
        <label id="label_firstname" htmlFor="chp_firstname">
          Prénom
        </label>
        <label id="label_lastname" htmlFor="chp_lastname">
          Nom
        </label>
        <input
          id="chp_firstname"
        ...
        <input
          ...
          required
        />
        <label htmlFor="chp_username">Nom d'utilisateur</label>
        <input
          id="chp_username"
          type="text"
        ...
        <input
          ...
          required
        />
        <label htmlFor="chp_pwd2">Confirmez votre mot de passe</label>
        <input
          id="chp_pwd2"
          type="password"
